...
class _PurchasePageState extends State<PurchasePage> {
  ...
  Future<Khalti?> initKhaltiPayment() async {
    ...
    if (response.statusCode == 200) {
      ...
      final payConfig = KhaltiPayConfig(
        //publicKey: 'test_public_key_cb5f3df6f4cd4d4f9ee83aa792d17e66',
        publicKey: 'e174aea240c4440c8c152ca5c330c8fe',
        pidx: pidx,
        returnUrl: Uri.parse(returnUrl),
        environment: Environment.test,
      );
...
// import '../../../feature/order/order-buyer/controller/order_place_controller.dart';
// import '../../../feature/product/addProduct/response/add_product_model_response.dart';
// // import 'payment_verification_model.dart'; // Import the model
...
//       );
//     } else {
//       debugPrint('Failed to initiate Khalti payment: ${response.body}');
//       return null;
//     }
//   }

//   // Future<void> verifyPayment(PaymentResult paymentResult) async {
//   //   final url = Uri.parse('https://a.khalti.com/api/v2/epayment/verify/');
//   //   final response = await http.post(
//   //     url,
//   //     headers: {
//   //       'Content-Type': 'application/json',
...
//   //       'amount': paymentResult.payload!.amount,
//   //     }),
//   //   );
...
//   //         PaymentVerificationResponseModel.fromJson(data);
//   //     debugPrint('Payment Verification: ${verificationResponse.toString()}');
//   //     // Handle the verification response here
//   //   } else {
//   //     debugPrint('Failed to verify Khalti payment: ${response.body}');
//   //   }
//   // }
...
//                                 Text(
//                                   'Quantity: ${widget.selectedItems[index].quantity}',
//                                   style: fBlackRegular14,
//                                 ),
//                               ],
//                             ),
...
//                 ),
//                 const SizedBox(height: 20),
//                 const Text("Delivery Location:", style: fBlackSemiBold18),
//                 const SizedBox(height: 10),
//                 TextField(
...
//                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                   children: [
//                     const Text("Total Price:", style: fBlackSemiBold18),
//                     Text('Rs. $totalPrice', style: fBlackSemiBold18),
//                   ],
//                 ),
//                 const SizedBox(height: 10),
//                 Row(
//                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                   children: [
//                     const Text("Delivery Charge:", style: fBlackSemiBold18),
//                     Text('Rs. $deliveryPrice', style: fBlackSemiBold18),
//                   ],
//                 ),
//                 const SizedBox(height: 10),
//                 Row(
//                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                   children: [
//                     const Text("Final Price:", style: fBlackSemiBold18),
//                     Text('Rs. $finalPrice', style: fBlackSemiBold18),
//                   ],
//                 ),
//                 const SizedBox(height: 20),
//                 Center(
...
//                       if (khaltiFuture == null) {
//                         Get.snackbar(
//                             'Error', 'Failed to initialize Khalti payment',
//                             backgroundColor: Colors.red,
//                             colorText: Colors.white);
//                         return;
//                       }

//                       final khalti = await khaltiFuture;
//                       if (khalti != null) {
//                         khalti.open(context);
//                       }
//                     },
